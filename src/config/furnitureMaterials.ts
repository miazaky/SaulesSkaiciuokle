export type FurnitureMaterialDef = {
  ...
  /** Optional: overrides the SKU extracted from name parens, for dynamic codes */
  skuFormula?: string; // formula id in registry that returns the SKU string
  note?: string;
};
...
export const solarGroundFurnitureMaterials: FurnitureMaterialDef[] = [
  ...
  // ── Clamp hardware ─────────────────────────────────────────────────────────
  { name: "Prispaudėjas galinis",                           qty: "furn_end_clamp",         skuFormula: "clampGCode" }, // SKU dynamic: Clamp G30/G35/G30J/G35J
  { name: "Prispaudėjas vidinis",                           qty: "furn_mid_clamp",         skuFormula: "clampVCode" }, // SKU dynamic: Clamp V / Clamp VJ
